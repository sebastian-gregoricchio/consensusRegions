...
author:
    -   name: "Sebastian Gregoricchio, Ph.D."
        affiliation:
            -   >-
                Netherlands Cancer Institute, Oncogenomics division,
...
output:
    BiocStyle::html_document:
        ...
        fig_caption: true
vignette: >
    %\VignetteIndexEntry{Consensus regions across replicated experiments}
...
`p < 0.001` and let `buildConsensus()` do the thresholding. The two-tier
design assumes exactly this.
